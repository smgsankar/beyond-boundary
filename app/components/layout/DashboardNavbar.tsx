    ...
    <header className="sticky top-0 z-50 w-full border-b border-surface-dark-hover bg-background-dark/95 backdrop-blur-sm">
      <div className="px-4 md:px-10 lg:px-40 py-3 flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center text-white">
          <Logo showText size="lg" className="hidden md:flex md:items-center" />
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/profile"
            className="size-10 rounded-full bg-center bg-cover border-2 border-surface-dark-hover cursor-pointer"
