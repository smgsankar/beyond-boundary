    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display min-h-screen flex flex-col overflow-x-hidden">
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-border-dark px-6 lg:px-10 py-4 bg-background-dark z-20 sticky top-0">
             <Link href="/" className="flex items-center gap-4 text-white cursor-pointer">
                 <div className="size-8"><Logo /></div>
                 <h2 className="text-white text-xl font-bold leading-tight tracking-[-0.015em]">BeyondBoundary</h2>
             </Link>
             <div className="hidden md:flex flex-1 justify-end gap-8">
                 <div className="flex items-center gap-9">
                     ...
                     <Link className="text-white text-sm font-medium leading-normal hover:text-primary transition-colors" href="/login">Login</Link>
                 </div>
                 <Link href="/signup">
            ...
            <div className="w-full h-full flex flex-col lg:flex-row">
                 ...
                 <div className="lg:w-1/2 flex flex-col justify-center px-6 md:px-16 py-12 bg-background-dark relative overflow-hidden group">
                     ...
                     <div className="relative z-10 max-w-lg">
                         <div className="mb-8">
                             <span className="inline-block px-3 py-1 bg-primary/20 text-primary text-xs font-bold uppercase tracking-wider rounded-full mb-4 border border-primary/20">Official Fantasy League</span>
                             ...
                             <p className="text-[#92c9a4] text-lg font-normal leading-relaxed mb-8">
                                 Build your dream team for the T20 World Cup. Compete with friends, track live scores, and win exclusive prizes every match day.
                             </p>
                 ...
                 <div className="lg:w-1/2 flex flex-col justify-center items-center px-4 md:px-16 py-12 bg-surface-dark/30 border-l border-border-dark relative">
                     <div className="w-full max-w-md">
                         <div className="mb-8">
                             ...
                             <p className="text-[#92c9a4] text-sm">Join thousands of managers around the world.</p>
                         </div>
                         <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                             <Input label="Username" icon="person" placeholder="Enter your manager name" />
                             <Input label="Email Address" icon="mail" placeholder="name@example.com" type="email" />
                             <Input label="Password" icon="lock" placeholder="Create a strong password" type="password" />
                             <Button type="submit" size="lg" fullWidth className="mt-2">Create Account</Button>
                         </form>
                         <div className="mt-8 text-center">
                             <p className="text-[#92c9a4] text-sm">
                                 Already have a team?
                                 <Link className="text-primary font-bold hover:underline decoration-2 underline-offset-4 ml-1" href="/login">Log in here</Link>
                             </p>
                         </div>
                     </div>
                 </div>
