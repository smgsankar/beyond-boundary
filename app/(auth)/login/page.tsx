      ...
      <div className="relative flex h-screen w-full flex-col overflow-hidden">
        ...
        <header className="relative z-10 flex items-center justify-between whitespace-nowrap border-b border-solid border-[#23482f] px-6 lg:px-10 py-4 bg-background-dark/80 backdrop-blur-md">
            <Link href="/" className="flex items-center gap-3 text-white cursor-pointer">
                ...
                <h2 className="text-white text-xl font-bold leading-tight tracking-tight">BeyondBoundary</h2>
            </Link>
            <div className="hidden sm:flex text-sm font-medium text-[#92c9a4]">
                Not a member yet? <Link className="ml-2 text-primary hover:underline" href="/signup">Sign up now</Link>
            </div>
        </header>
        ...
        <main className="relative z-10 flex flex-1 items-center justify-center p-4">
            <div className="w-full max-w-[480px] flex-col rounded-2xl bg-surface-dark border border-[#326744] p-6 shadow-2xl sm:p-10">
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    <Input label="Email or Username" placeholder="Enter your email or username" type="text" />
                    ...
                    <Button type="submit" size="lg" fullWidth className="mt-2">Log In</Button>
                </form>
            </div>
        </main>
      </div>
